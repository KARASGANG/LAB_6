...
void createInitialData() {
    ...
    Footballer footballers[] = {
        {"Mukhin Jaromir", "MIEM", "forward", 20, 172, 98},
        {"Prytkov Roman", "MIEM", "forward", 18, 196, 123},
        {"Slastnikov Sergey", "MIEM", "midfielder", 41, 86, 42},
        {"Bober Stanislav", "MIEM", "midfielder", 31, 112, 28},
        {"Shchur Lev", "MIEM", "defender", 70, 97, 12},
        {"Kochetkov Yuri", "MIEM", "defender", 72, 97, 12},
